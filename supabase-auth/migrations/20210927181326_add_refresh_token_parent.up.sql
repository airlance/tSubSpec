...
BEGIN
  IF NOT EXISTS(SELECT *
    ...
    WHERE table_name='refresh_tokens' and constraint_name='refresh_tokens_token_unique')
  THEN
  ...
  IF NOT EXISTS(SELECT *
    FROM information_schema.constraint_column_usage
    WHERE table_name='refresh_tokens' and constraint_name='refresh_tokens_parent_fkey')
  THEN
